export function MedioambienteSection() {
  return (
    <section className="bg-[#05ed96] px-10 py-20 border-t border-[rgba(5,237,150,0.15)]">
      <div className="max-w-[960px] mx-auto">
        <h3
          className="font-[family-name:var(--font-unbounded)] uppercase text-[#0a0a0a] mb-10"
        ...
        <div className="grid grid-cols-[auto_1fr] gap-16 items-center">
          ...
          <div>
            <p className="font-[family-name:var(--font-instrument-serif)] text-[1.1rem] text-[rgba(8,8,8,0.72)] leading-[1.65] mb-4">
            ...
            <p className="font-[family-name:var(--font-instrument-serif)] text-[1.1rem] text-[rgba(8,8,8,0.72)] leading-[1.8]">
