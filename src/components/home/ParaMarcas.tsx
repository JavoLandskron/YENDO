    ...
    <section className="py-16 md:py-24 px-5 sm:px-8 md:px-10 bg-[#080808] border-t border-[rgba(244,241,232,0.04)]" id="marcas">
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 mb-10 md:mb-12">
          ...
          <div className="reveal">
            <p className="text-[1rem] md:text-[1.1rem] text-[rgba(244,241,232,0.65)] leading-[1.65] mb-4 font-[family-name:var(--font-instrument-serif)]">
            ...
            <Link
              href="/suscripcion"
              className="inline-flex items-center gap-2 bg-[#05ed96] text-[#080808] px-6 sm:px-7 py-3.5 rounded-full font-[family-name:var(--font-unbounded)] text-[0.72rem] tracking-[0.06em] uppercase no-underline hover:bg-[#04c97e] hover:-translate-y-px active:scale-[0.98] transition-all mt-2"
            >
              Quiero ser parte →
            </Link>
          </div>
        ...
        >
          {GANA_ITEMS.map((item) => (
            <div
              key={item.n}
              className={`reveal ${item.delay} bg-[#080808] p-7 sm:p-10 md:p-12 relative hover:bg-[rgba(5,237,150,0.03)] transition-colors group`}
            >
              <div className="absolute top-0 left-0 w-0.5 h-0 bg-[#05ed96] transition-all duration-300 group-hover:h-full" />
              <div className="font-[family-name:var(--font-unbounded)] text-[2rem] md:text-[2.5rem] text-[#05ed96] opacity-50 leading-none mb-3 md:mb-4 tracking-[0.01em]">
                {item.n}
              </div>
        ...
        {/* Medioambiente block */}
        <div className="reveal mt-px bg-[#05ed96] p-7 sm:p-10 md:p-12">
          <h3
            className="font-[family-name:var(--font-unbounded)] uppercase text-[#080808] mb-7 md:mb-10"
            style={{ fontSize: 'clamp(1.6rem,6vw,3rem)', lineHeight: 1.05, letterSpacing: '-0.02em' }}
          >
            ¿Qué gana el medioambiente?
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-[auto_1fr] gap-6 sm:gap-12 sm:items-center">
            <div>
              <div
            ...
            <div>
              <p className="text-[1rem] md:text-[1.05rem] text-[rgba(8,8,8,0.78)] leading-[1.6] md:leading-[1.65] font-[family-name:var(--font-instrument-serif)] mb-4">
              ...
              <p className="text-[1rem] md:text-[1.05rem] text-[rgba(8,8,8,0.78)] leading-[1.6] md:leading-[1.65] font-[family-name:var(--font-instrument-serif)]">
