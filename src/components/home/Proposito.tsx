export function Proposito() {
  return (
    <section
      className="py-24 px-10 bg-[#161616] border-t border-[rgba(244,241,232,0.04)] relative overflow-hidden"
      id="proposito"
    >
      {/* Glow */}
      <div
      ...
      <div className="max-w-[1100px] mx-auto relative">
        ...
        <div className="grid md:grid-cols-2 gap-24 items-start">
          ...
          <div className="pt-2 reveal">
            <p className="text-[1.12rem] text-[rgba(244,241,232,0.65)] leading-[1.65] mb-6 font-[family-name:var(--font-instrument-serif)]">
